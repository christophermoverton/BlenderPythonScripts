...
## This version of RandomComplex4 works differently at the outset relative
## RandomComplex3 where given a Circle of specified center and radius,
## generating three unique positions defining a base 3 polygon as opposed
...
def generateRandomVertex2(center, radius):
    rtheta = 2*math.pi*random.random()
    cx,cy = center
    xpos = radius*math.cos(rtheta)+ cx
    ypos = radius*math.sin(rtheta)+ cy
    return (xpos, ypos)
...
def generatePolygon(center,radius, MaxScaleIterations, PolygonSize):
    ...
    rotheir = {}
    for i in range(0,3):
        vertices.append(generateRandomVertex2(center, radius))
